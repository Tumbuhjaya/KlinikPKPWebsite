      ...
      <b-container>
        ...
        <b-row>
          <b-col md="4" offset-md="4">
            ...
            <div class="box-submenu">
              ...
              <h6 class="m-t-0 m-b-0"><strong>Input CSR</strong></h6>
            </div>
            <hr class="m-t-10 m-b-10" />
          </b-col>
        </b-row>
        ...
        <b-row>
            <b-col md="8" offset-md="2" >
                ...
                <b-form-group label="Upload Foto Kegiatan">
                    <b-form-file id="foto2" ref="foto2"  @input="handleFile()"></b-form-file>
                </b-form-group>

                <b-form-group label="Upload Foto Kegiatan">
                    <b-form-file id="foto3" ref="foto3"  @input="handleFile()"></b-form-file>
                </b-form-group>


                <b-button variant="primary" @click="regisCsr()">Simpan</b-button>
            </b-col>
        </b-row>
